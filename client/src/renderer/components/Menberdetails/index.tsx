        ...
        <div className='menberdetails-info'>
           ...
           <div className='menberdetails-info__content'>
                <ul>
                    ...
                    <li>
                        <p className='menberdetails-info__content__title menberdetails-info__content__title--icnname'>Họ tên:</p>
                        <p className='menberdetails-info__content__text'>Phan Ho Tu</p>
                    </li>
                    <li>
                        <p className='menberdetails-info__content__title menberdetails-info__content__title--icngroup'>Nhóm:</p>
                        <p className='menberdetails-info__content__text'>Web</p>
                    </li>
                    <li>
                        <p className='menberdetails-info__content__title menberdetails-info__content__title--icnaddress'>Địa chỉ:</p>
                        <p className='menberdetails-info__content__text'>aaa</p>
                    </li>
                    <li>
                        <p className='menberdetails-info__content__title menberdetails-info__content__title--icnphone'>Điện thoai:</p>
                        <p className='menberdetails-info__content__text'>90909090</p>
                    </li>
                    <li>
                        <p className='menberdetails-info__content__title menberdetails-info__content__title--icnemail'>Email:</p>
                        <p className='menberdetails-info__content__text'>aaa@gmail.com</p>
                    </li>
                    <li>
                        <p className='menberdetails-info__content__title menberdetails-info__content__title--icnskype'>Skype ID:</p>
                        <p className='menberdetails-info__content__text'>aaa@gmail.com</p>
                    </li>
                </ul>
