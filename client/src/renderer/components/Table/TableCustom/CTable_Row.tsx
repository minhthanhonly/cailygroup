  ...
  return (
    <>
      <tr>
        ...
        <td>
          <button className="btn btn--medium">xác nhận</button>
        </td>
        <td>
          <button className="btn btn--medium">cập nhật</button>
        </td>
        <td>
          <button className="btn btn--medium">Đăng Ký Nghỉ Phép</button>
        </td>
        <td>
      ...
      <tr>
        <td>
          <input className="input__edit" type="text" value="12:12" />
        </td>
        <td>
          <input className="input__edit" disabled type="text" value="12:12" />
        </td>
        <td>
          <input className="input__edit" type="text" />
        </td>
        <td>
          <input className="input__edit" type="text" />
        </td>
