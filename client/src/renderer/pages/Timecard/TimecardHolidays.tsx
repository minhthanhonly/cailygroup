...
const TimecardHolidays = () => {
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <div className="form-group">
                                            ...
                                            <input value={modalName} onChange={(e) => setModalName(e.target.value)} className="form-input" type="text" placeholder="Nhập Tên Ngày Lễ"  />
                                        </div>
                                        <div className="holiday">
                                            <div className="form-group">
                                                <label>Ngày Nghỉ Lễ:</label>
                                                <img src={require('../../../../assets/icon-time.jpg')} alt="" className="fluid-image" />
                                                <DatePicker multiple value={modalDays} onChange={(date) => handleDatePickerModalChange(date)} format="DD-MM-YYYY" />
                                            </div>
                                        </div>
                                        <div className="wrp-button">
                                            <button className="btn btn--green" onClick={(event) => handleUpdate(modalId, modalName, modalDays as [], event)} > Xác nhận </button>
    ...
    let dynamicDelete = (id:any) => (
        <>
            <button onClick={() => {openModaldelete(id);}}>
                <p className="icon icon--check">
