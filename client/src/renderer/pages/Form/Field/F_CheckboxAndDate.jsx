...
class F_CheckboxAndDate extends React.Component {
  constructor(props) {
    super(props);
    this.custom_options = {};
  }
                  ...
                  return (
                    <>
                      ...
                      <label className="c-form-label--03">
                        ...
                        <input type="text" className="c-form-control c-form-control--02" placeholder='yyyy/mm' />
...
export default F_CheckboxAndDate;
